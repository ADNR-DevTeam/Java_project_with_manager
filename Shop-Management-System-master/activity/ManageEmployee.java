...
public class ManageEmployee extends JFrame implements ActionListener {
	...
	private JLabel title, header, userIdLabel, employeeNameLabel, phoneNumberLabel, roleLabel, salaryLabel, roleCB;
	...
	public ManageEmployee(String eid, ViewEmployeeActivity prev) {
		...
		phoneCodeTF = new JTextField("+972");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonEdit)) {
			try {
				employee.updateEmployee(employeeNameTF.getText(),Integer.parseInt(phoneNumberTF.getText()),roleCB.toString(), Double.parseDouble(salaryTF.getText()));
